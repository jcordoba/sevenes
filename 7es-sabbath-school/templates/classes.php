...
<head>
    ...
    <title>Clases/Unidades | 7es Sabbath School</title>
    <link rel="stylesheet" href="<?php echo SABBATH_SCHOOL_PLUGIN_URL.'assets/css/dashboard.css'; ?>">
    <link rel="stylesheet" href="<?php echo SABBATH_SCHOOL_PLUGIN_URL.'assets/css/classes.css'; ?>">
</head>
<body>
    <div class="ss-dashboard-wrapper">
        <header>
            <h1>Gestión de Clases/Unidades</h1>
            <nav>
